...
// ================================================================================================================
    ...
    public List<ProductOrderResponse> getProductsByIds(List<Long> productIds) {
...
//                .imageUrl(getUrls(product.getId()).get(0))
    ...
    private Map<String, String> getClothesSizeAndColor(Product product) {
    ...
    public ProductOrderResponse toOrderResponse(Product product) {
...
//              getUrls(product.getId()).get(0),
                ...
                product.getPrice(),
                cartProductRepository.findCountByProductId(product.getId()),
